...
class User(Base):
    ...
    playlist_collaborations = relationship("PlaylistCollaborator", back_populates="collaborator", lazy="select", foreign_keys="PlaylistCollaborator.collaborator_id")
    ...
    followings = relationship("Following", back_populates="user", lazy="select", cascade="all, delete-orphan", foreign_keys="Following.user_id")
    # Admin uploads songs
